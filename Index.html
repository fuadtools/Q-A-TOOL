...
What is 2+2?|4"></textarea>
    ...
    <script>
        ...
        // Sound Effects
        const sounds = {
            question: new Audio('https://assets.mixkit.co/sfx/preview/mixkit-positive-interface-beep-221.mp3'),
            answer: new Audio('https://assets.mixkit.co/sfx/preview/mixkit-correct-answer-tone-2870.mp3'),
            tick: new Audio('https://assets.mixkit.co/sfx/preview/mixkit-clock-countdown-bleeps-916.mp3'),
            transition: new Audio('https://assets.mixkit.co/sfx/preview/mixkit-game-show-suspense-waiting-668.mp3')
        };
        ...
        function showQuestion(index) {
            ...
            if (elements.soundEffects.checked) {
                sounds.question.play().catch(e => console.error("Sound error:", e));
            }
        ...
        function showAnswer(index) {
            ...
            // Play sound if enabled
            if (elements.soundEffects.checked) {
                sounds.answer.play().catch(e => console.error("Sound error:", e));
        ...
        function showCountdown(seconds, callback) {
            ...
            state.countdownInterval = setInterval(() => {
                ...
                if (elements.soundEffects.checked) {
                    sounds.tick.play().catch(e => console.error("Sound error:", e));
                }
